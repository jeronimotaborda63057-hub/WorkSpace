...
public class TestMenuShapes {
    public static void main(String[] args) {
        ...
        double x, y, firstSide, secondSide, thirdSide, mayorAxis, minorAxis, addA = 0, addP = 0;
        boolean menu = true;
        ...
        while (menu) {
            ...
            switch (option) {
                case 1 -> {
                    ...
                    switch (optionShape) {
                        ...
                        case 4 -> {
                            ...
                            shapes.addShape(new Triangle(id, x, y, firstSide, secondSide, thirdSide));
                ...
                case 2 -> {
                    ...
                    for (Shape shape : shapes.getShapeList()) {
                        ...
                        if (shape instanceof Square) {
                            ...
                            System.out.println("\n - Base: " + rectangle.getBase() + " cm\n - Altura: "
                                    + rectangle.getHeight() + " cm");
                        } else if (shape instanceof Circle) {
                            circle = (Circle) shape;
                            System.out.println("\n - Radio: " + circle.getRadius() + " cm");
                        } else if (shape instanceof Triangle) {
                            triangle = (Triangle) shape;
                            System.out.println("\n - Lado 1: " + triangle.getFirstSide() + " cm\n - Lado 2: "
                                    + triangle.getSecondSide() + " cm\n - Lado 3: " + triangle.getThirdSide() + " cm");
                        } else if (shape instanceof Oval) {
                            oval = (Oval) shape;
                            System.out.println("\n - Eje mayor: " + oval.getMayorAxis() + " cm\n - Eje menor: "
                                    + oval.getMinorAxis() + " cm");
                        }
                        System.out.println(
                                "\n - Área: " + shape.area() + " cm2\n - Perímetro: " + shape.perimeter() + " cm");
                    }
                }
                case 3 -> {
                    // CONSULTAR FIGURA
                ...
                case 4 -> {
                    System.out.println("\n- El área total de todas las figuras es: " + shapes.getShapesTotalArea() + " cm2\n- El perímetro total de todas las figuras es: " + shapes.getShapesTotalPerimeter() + " cm");
                }
                default -> {
                    menu = false;
                }
